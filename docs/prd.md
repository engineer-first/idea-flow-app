...
> MVP は **デザインスプリント形式**（課題整理 → 問いの作成 → アイデア発想 → アイデア決定 → ペルソナ作成 → 成果物出力）として具体化した。
...
Miro や Figma のような自由なホワイトボードとは違い、**デザインスプリント形式の進行フロー**（課題整理 → 問いの作成 → アイデア発想 → アイデア決定 → ペルソナ作成 → 成果物出力）に沿ってアイデア出しを支援。AI ファシリテーターがステップごとにガイドし、進め方に迷わず、成果物まで到達できます。
...
| 解決する問題 | 「何を作るか決められない」 |
| できること | AI ファシリテーターの案内で、課題整理からアイデア決定・ペルソナ作成・成果物出力までを1つの流れで進められる |
...
| 課題 | 背景 | 解決方針 |
| --- | --- | --- |
| 何から考えればよいか分からない | アイデア出しに慣れていないチームは、最初に何を考え、どの順番で進めればよいかが分からず、議論が止まりやすい。 | 「①ルーム → ②課題整理 → ③問いの作成 → ④アイデア発想 → ⑤アイデア決定 → ⑥ペルソナ作成 → ⑦成果物出力」という固定フローと AI ファシリテーターのガイド文で、今やることを常に明示する。 |
| アイデアが広がらない | 最初に思いついた案から抜け出せず、視点や切り口が固定されやすい。 | アイデア発想（Sketch）フェーズのサイドバーに、オズボーンのチェックリスト・SCAMPER・逆転発想・他業界事例といった発想支援ツールを常設する。 |
| 意見が出る人に偏る | 会議中心の進め方では、事前準備してきた人、書くのが早い人、声の大きい人の意見に偏りやすい。 | 各フェーズの Step1 を個人専用付箋 + タイマーによる個人ワークとし、全員が自分の案を出してから共有・分類に進む構成にする。 |
| アイデアを整理できない | アイデアが増えるほど全体像が見えにくくなり、似た案や重要な観点を見落としやすい。 | 共有・分類ステップでホワイトボード上のグルーピングを行い、アイデア決定（Decide）フェーズでは価値 × 実現難易度の2軸マッピングで整理する。 |
...
そこで本サービスでブレストルームを作成し、招待コードを共有して全員が参加。AI ファシリテーターの案内に沿って課題整理・HMW作成・アイデア発想・決定・ペルソナ作成まで進み、最後に成果物として持ち帰れる。
...
進行を一人で抱え込まずに済む。AI ファシリテーターがステップごとに進行と問いかけを担うため、進行役はチーム全体でアイデア出しを進めることに集中できる。
...
| No. | Goal |
| --- | --- |
| 1 | アイデア出しに慣れていない初学者チームでも、AI ファシリテーターの案内に沿ってデザインスプリントの一連の流れ（①〜⑦）を迷わず完走できる |
...
| 5 | 採用したアイデアをもとにペルソナを具体化し、成果物として持ち帰れる形（Markdown / PDF / PNG）で出力できる |
...
| 3 | 完全自動で最適な企画を作ること | AI は意思決定者ではなく、各フェーズの進行・問いかけを担うファシリテーター役のため |
| 4 | 高度なデザインツール機能・資料作成機能 | 成果物出力はシンプルな Markdown / PDF / PNG に留め、デザインツールの代替は目指さないため |
| 5 | 本格的なプロジェクト管理機能 | Jira / GitHub Projects の代替ではないため |
| 6 | 大規模組織向けの権限管理 | 初期対象は少人数の学生チームのため |
| 7 | デザインスプリント以外の進行フォーマット | MVP はデザインスプリント形式の1本のフローに絞り、フロー自体のカスタマイズは対象外とする |
...
- **AI ファシリテーターが各ステップをガイド**：迷ったときに何をすべきかを常に AI が言葉で示す

### 6.3 ① ルーム

| 項目 | 内容 |
| --- | --- |
| 機能 | ルーム作成 / 招待コード発行 / メンバー参加 / メンバー一覧 / 全員の参加確認 / ワーク開始 |
| AI ガイド例 | 「ようこそ！ 皆さんで課題を整理し、アイデアを考えていきます。デザインスプリントが初めてでも大丈夫です。私が順番に案内します。」 |
...
| Step2 共有・分類 | ホワイトボード / 順番に発表 / グルーピング | 「似ている課題は近くへまとめましょう。無理にまとめなくても大丈夫です。」 |
| Step3 課題投票 | 🔴主観ドット×1 / 🔵客観ドット×3 / ステルス投票 | 「一番重要だと思う課題へ投票してください。他の人の意見は気にしなくて大丈夫です。」 |
| Step4 課題決定 | 投票結果表示 / 取り組む課題の確定 | 「取り組む課題が決まりました！ 次は、この課題を『アイデアが生まれやすい問い（HMW）』へ変換していきます。」 |
...
| Step | 機能 | AI ガイド例 |
| --- | --- | --- |
| Step1 HMW作成 | 決定した課題を画面上部に固定表示 / 「How Might We（どうしたら私たちは〇〇できるだろう？）」形式の入力 / テンプレート（もっと簡単に / もっと安心して / もっと楽しく / もっと短時間で / もっと継続して） | 「HMWは答えを書く場所ではありません。アイデアが広がる『問い』を作りましょう。」 |
| Step2 共有・分類 | HMW共有 | 「他の人の問いを見て、新しい視点がないか考えてみましょう。」 |
| Step3 HMW投票 | 🔴主観ドット×1 / 🔵客観ドット×3 / ステルス投票 | 「最もアイデアが広がりそうな問いへ投票してください。」 |
| Step4 HMW決定 | 投票結果表示 / HMWの確定 | 「HMWが決まりました！ 次は、この問いをもとに解決策を考えていきます。」 |

### 6.6 ④ アイデア発想（Sketch）

**フェーズの目的**：HMWに対する解決策をたくさん考える

| Step | 機能 | AI ガイド例 |
| --- | --- | --- |
| Step1 アイデアを書く | 個人作業 / タイマー / 付箋入力 / サイドバーに発想支援ツール（オズボーンのチェックリスト・SCAMPER・逆転発想・他業界事例） | 「質より量です。思いついたアイデアはどんどん書き出しましょう。」 |
| Step2 共有・分類 | 順番に発表 / グルーピング | 「他の人のアイデアからヒントを得ても構いません。」 |

### 6.7 ⑤ アイデア評価・決定（Decide）

**フェーズの目的**：最も価値のあるアイデアを決定する

| Step | 機能 | AI ガイド例 |
| --- | --- | --- |
| Step1 アイデア整理 | グルーピング / 重複整理 | - |
| Step2 価値評価 | 2軸マッピング（縦軸：選定した課題・HMWへの価値、横軸：実現難易度）／ ホストのみドラッグ可能（案） | 「このアイデアは利用者に価値がありますか？ 実現可能性も考えてみましょう。」 |
| Step3 アイデア投票 | 🔴主観ドット×1 / 🔵客観ドット×3 / ステルス投票 | 「最も実現したいアイデアへ投票してください。」 |
| Step4 アイデア決定 | 投票結果表示 / 採用アイデアの確定 | 「🎉 採用するアイデアが決まりました！ 次は、このアイデアを利用する人物像を具体化します。」 |

### 6.8 ⑥ ペルソナ作成

> ここでの「ペルソナ」は、[想定ユーザー](#3-想定ユーザー)（本プロダクトを使うチーム像）とは異なり、**チームが採用したアイデアを利用する架空の人物像**を指す、プロダクト内の成果物のひとつ。要検討フェーズ。

**フェーズの目的**：アイデアを利用する人物像を具体化する

| 項目 | 内容 |
| --- | --- |
| 編集項目 | AI が作成した初期案を編集：顔イラスト / 年齢 / 職業 / 趣味 / ライフスタイル / 困っていること / サービスを利用して嬉しくなること |
| 常時表示 | 採用した課題 / 採用したHMW / 採用したアイデア |
| AI ガイド例 | 「このアイデアを最も喜ぶ人を想像してみましょう。実在する人物をイメージすると考えやすくなります。」 |

### 6.9 ⑦ 成果物の出力

**フェーズの目的**：デザインスプリントの成果物をまとめる

| 項目 | 内容 |
| --- | --- |
| 表示内容 | 最終決定したアイデア案 / 採用した課題・HMW・アイデアのつながりを示すアウトプット |
| 出力形式（発展予定） | Markdown / PDF（PNG は将来対応） |
...
| デザインスプリント進行フロー | ①ルーム〜⑦成果物出力までの7フェーズを、1画面1フェーズ・Stepper形式で迷わず進められる |
...
| 2軸マッピング（価値 × 実現難易度） | アイデア決定フェーズで、価値と実現難易度の2軸でアイデアを整理・評価できる |
| 発想支援ツール（サイドバー） | アイデア発想フェーズで、オズボーンのチェックリスト・SCAMPER・逆転発想・他業界事例を参照できる |
| ペルソナ作成支援 | AI が生成したペルソナ初期案をもとに、採用アイデアを使う人物像を具体化できる |
| 成果物出力 | 採用した課題・HMW・アイデア・ペルソナのつながりを、Markdown / PDF で出力できる |
| AI ファシリテーション | 各ステップで次に何をすべきかをガイドし、進行役がいなくても迷わず進められる |

> 進行フローの詳細図は [`docs/ds-flow.md`](./ds-flow.md)、各フェーズの機能・AIガイド設計の詳細は [`docs/dezain-supurinto.md`](./dezain-supurinto.md) を参照。
...
| 主な価値 | 多様な共同作業を1キャンバスで | 課題整理〜成果物出力までの7フェーズで迷わず進む |
| ターゲット | 企業・デザイン/開発チーム・全般 | ハッカソン・ビジコン・学生・初学者 |
| 自由度 | 非常に高い | あえて絞る（フローは固定） |
| AI の役割 | 付箋整理・要約・生成・効率化 | 各ステップのファシリテーション・問いかけ・進行支援 |
...
> 本プロダクトは、何を考えればよいか分からないチームを、デザインスプリントの型でアイデア創出から成果物出力まで案内するツール。
...
- **型があること** — 課題整理 → 問いの作成 → アイデア発想 → 決定 → ペルソナ作成 → 成果物出力という、デザインスプリントの型に AI が組み込まれている
- **残ること** — 会話で消えず、アイデアが付箋や成果物として可視化され、全員で整理・投票・選定・出力できる

つまり「賢い相談相手（ChatGPT）」ではなく、「チームのデザインスプリントを前に進める進行役」を AI に担わせる点が差別化になる。
...
- チームで同時にアイデアを出せる
- 付箋形式でアイデアを見える化
- AI が各ステップをファシリテーションする
- 課題整理からアイデア決定・ペルソナ作成・成果物出力までを1つの流れで完走できる
...
- [`docs/dezain-supurinto.md`](./dezain-supurinto.md) — 各フェーズの機能・AIガイド設計の詳細
