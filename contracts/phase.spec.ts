...
describe("RoomPhase の表示ラベル", () => {
  it.each([
    ...
    [buildPhaseStep(1), "1-1 課題を個人で書く"],
    [buildPhaseStep(2), "1-2 共有する"],
    [buildPhaseStep(3), "1-3 グループ化"],
    [buildPhaseStep(4), "1-4 ステルス投票"],
    [buildPhaseStep(5), "1-5 集計確認・絞り込み"],
    [buildPhaseStep(1, 2), "2-1 HMWを個人で書く"],
    [buildPhaseStep(2, 2), "2-2 共有する"],
    [buildPhaseStep(3, 2), "2-3 ステルス投票"],
    [buildPhaseStep(4, 2), "2-4 集計確認・絞り込み"],
    [buildPhaseStep(1, 3), "3-1 アイデアを個人で書く"],
